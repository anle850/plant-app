...
// List plantListCategory = [
//   _plantList.where((element) => element.category == 'Recommended').toList(),
//   _plantList.where((element) => element.category == 'Indoor').toList(),
//   _plantList.where((element) => element.category == 'Outdoor').toList(),
//   _plantList.where((element) => element.category == 'Recommended').toList(),
//   _plantList.where((element) => element.category == 'Recommended').toList(),
//
// ];
